          ...
          <div className="max-w-5xl mx-auto">
            ...
            <FadeIn>
              <div className="text-center mb-6 sm:mb-8">
                <div className="inline-flex items-center space-x-2 bg-orange-100 text-orange-700 rounded-full px-3 py-1.5 mb-3 sm:mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Link href="/contact">
                    <Button size="lg" className="bg-orange-600 hover:bg-orange-700 shadow-lg w-full sm:w-auto">
                      Get Started
            ...
            <FadeIn delay={0.5}>
              <div className="mt-4 sm:mt-6 bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
                  ...
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-green-600 mb-1">Save</div>
                    <div className="text-xs text-gray-600">Time & Money</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-blue-600 mb-1">Auto</div>
                    <div className="text-xs text-gray-600">Workflows</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-purple-600 mb-1">Smart</div>
        ...
        <div className="container mx-auto px-4">
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center space-x-2 bg-orange-100 text-orange-700 rounded-full px-4 py-2 mb-6">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Stop doing repetitive tasks manually. Automate your business processes and focus on what really matters - growing your business.
              </p>

              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-4xl font-bold text-orange-600 mb-2">01</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Save Hours Daily</h3>
                  <p className="text-sm text-gray-600">Automate repetitive tasks and free up your time</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-4xl font-bold text-green-600 mb-2">02</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Reduce Errors</h3>
                  <p className="text-sm text-gray-600">Automated systems work flawlessly every time</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-4xl font-bold text-blue-600 mb-2">03</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Scale Easily</h3>
                  <p className="text-sm text-gray-600">Handle more work without hiring more staff</p>
                </div>
              </div>
            </div>
          </FadeIn>
