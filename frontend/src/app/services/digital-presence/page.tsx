            ...
            <FadeIn delay={0.5}>
              <div className="mt-4 sm:mt-6 bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
                  ...
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-orange-600 mb-1">Fast</div>
          ...
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your digital presence is the first impression customers have of your business. Make it count with our professional services.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <p className="text-sm text-gray-600">Modern, clean designs that reflect your brand identity</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <p className="text-sm text-gray-600">Built to rank well on search engines from day one</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
