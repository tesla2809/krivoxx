          ...
          <div className="max-w-5xl mx-auto">
            ...
            <FadeIn>
              <div className="text-center mb-6 sm:mb-8">
                <div className="inline-flex items-center space-x-2 bg-purple-100 text-purple-700 rounded-full px-3 py-1.5 mb-3 sm:mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Link href="/contact">
                    <Button size="lg" className="bg-purple-600 hover:bg-purple-700 shadow-lg w-full sm:w-auto">
                      Get Started
                      <ArrowRight className="w-5 h-5 ml-2" />
                    </Button>
                  </Link>
                  <Link href="/pricing">
                    <Button size="lg" variant="outline" className="border-purple-600 text-purple-600 hover:bg-purple-50 w-full sm:w-auto">
                      View Pricing
                    </Button>
                  </Link>
                </div>
            ...
            <FadeIn delay={0.5}>
              <div className="mt-4 sm:mt-6 bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
                  ...
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-blue-600 mb-1">Custom</div>
                    <div className="text-xs text-gray-600">Built Solutions</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-green-600 mb-1">Latest</div>
                    <div className="text-xs text-gray-600">Technology</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-bold text-orange-600 mb-1">Scalable</div>
          ...
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Advanced Technology for Growing Businesses
              </h2>
              
              <p className="text-lg text-gray-600 mb-8">
                Custom-built solutions that give you a competitive edge. Perfect for businesses ready to scale and automate complex operations.
              </p>

              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-4xl font-bold text-purple-600 mb-2">01</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Custom Built</h3>
                  <p className="text-sm text-gray-600">Tailored exactly to your business needs</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  ...
                  <p className="text-sm text-gray-600">Latest frameworks and best practices</p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-md">
                  <div className="text-4xl font-bold text-green-600 mb-2">03</div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Future Proof</h3>
                  <p className="text-sm text-gray-600">Built to scale with your growth</p>
                </div>
              </div>
            </div>
          </FadeIn>
